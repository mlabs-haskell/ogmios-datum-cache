...
let
  ...
  f = { mkDerivation, aeson, base, base16, base64, bytestring
      , conduit, containers, cryptohash-sha256, directory, esqueleto
      , exceptions, filepath, hasql, http-types, lib, monad-logger, mtl
      ...
      mkDerivation {
        ...
        executableHaskellDepends = [
          aeson base base16 base64 bytestring conduit containers
          cryptohash-sha256 directory esqueleto exceptions filepath hasql
          http-types monad-logger mtl network optparse-applicative persistent
